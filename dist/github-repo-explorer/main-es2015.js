...
let BackgroundMessageComponent = class BackgroundMessageComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let IssueCardComponent = class IssueCardComponent {
    ...
    ngAfterViewInit() {
        ...
        let markdown = new markdown_it__WEBPACK_IMPORTED_MODULE_2___default.a();
...
let NavbarComponent = class NavbarComponent {
    constructor(sharedDataService, router) {
        ...
        this.router = router;
        this.searchTerm = "";
        this.searchTermChangedSubscription = this.sharedDataService.searchTermChanged.subscribe((newSearchTerm) => {
...
class ChartData {
    constructor(values, colorDomains, colors) {
        this.values = values;
        this.colorDomains = colorDomains;
        this.colors = colors;
    }
}
ChartData.ctorParameters = () => [
    { type: Object },
    { type: Array },
    { type: Array }
];
...
let HomeComponent = class HomeComponent {
    constructor(gitHubService, route, sharedDataService) {
...
let GitHubService = class GitHubService {
    ...
    getIssuesForRepository(owner, name, state) {
